...
export default function Setup() {
  ...
  const statusLine = !devices
    ? ""
    : [
        devices.headset.kind === "real" ? "Headset detected. Start to check its live signal." : "Turn your headset on before you start; without one, focus is simulated for practice.",
  ...
  return <section className="quick-start">
    ...
    <p className="small muted">With a real headset, start with a 30-second focused calibration. Your microphone starts after calibration.</p>
