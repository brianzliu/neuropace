...
export interface Dashboard { sessions: (SessionRow & {title: string})[]; concepts: Concept[]; closed: number; summary: string; organization_source: string; curriculum: Curriculum }
