 ...
 * sidebar and the Lectures history list. Deep links go through the legacy /notes/:id etc. paths,
 * which redirect into the Library shell, so this stays valid regardless of which screen embeds it. */
